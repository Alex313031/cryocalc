...
# Compiler flags #
DEFINES  := -DUNICODE -D_UNICODE -D_WINDOWS -DWINVER=0x0501 -D_WIN32_WINNT=0x0501 -D_WIN64_WINNT=0x0502 -D_WIN32_IE=0x600
...
# Libraries
LIBS     := -lkernel32 -luser32 -lshell32 -lcomctl32 -lcomdlg32 -lgdi32 -ladvapi32 -lole32
# Linker flags
